...
Route::middleware(['auth'])->group(function () {
    ...
    //Rotas dos Posts
    Route::post('/create/category', [App\Http\Controllers\CategoryController::class, 'store'])->name('create.post');
    Route::get('/api/list/categories', [App\Http\Controllers\CategoryController::class, 'listCategories'])->name('list.post');
    Route::get('/api/categories', [App\Http\Controllers\CategoryController::class, 'index'])->name('list.post');
    Route::get('/list/categories', [App\Http\Controllers\CategoryController::class, 'list'])->name('list.post');
