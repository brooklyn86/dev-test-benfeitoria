            ...
            <div class="card-body">
                ...
                <p class="card-text">Liastagem de todas as categorias.</p>
                    ...
                    <div class="py-5 row g-3 align-items-center">
                        ...
                        <div class="col-auto">
                            <button type="button" @click="loadCategories" class="btn btn-primary">Filtrar</button>
                        </div>
                    </div>
                <table class="table" id="posts" >
                    ...
                    <tbody v-for="(category, index) in categoryItens.data" :key="index">
                        ...
                        <td><a :href="`/api/destroy/category/${category.id}`"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
    ...
    export default {
        ...
        methods:{
          async loadCategories(page=1){
              await axios.get(`/api/categories?page=${page}&title=${this.title}`).then(({data})=>{
